...
\restrict cG64PaP8J2OgXFS6aF3nxpNfpJCDj2buLGdBuODncfQhoy4c5Sk5GBMqHUnRRcF
...
CREATE TABLE public.room (
    ...
    CONSTRAINT room_current_step_check CHECK (((current_step)::text = ANY ((ARRAY['RoleSelection'::character varying, 'DealConfirmation'::character varying, 'Payment'::character varying, 'Delivery'::character varying, 'Completed'::character varying, 'Cancelled'::character varying])::text[]))),
    ...
    CONSTRAINT room_product_type_check CHECK (((product_type)::text = ANY ((ARRAY['Physical'::character varying, 'Digital'::character varying])::text[]))),
...
--
-- Name: room_reminders; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.room_reminders (
...
ALTER TABLE public.room_reminders OWNER TO postgres;

--
-- Name: room_reminders_reminder_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.room_reminders_reminder_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.room_reminders_reminder_id_seq OWNER TO postgres;

--
-- Name: room_reminders_reminder_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: room_reminders reminder_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.room_reminders ALTER COLUMN reminder_id SET DEFAULT nextval('public.room_reminders_reminder_id_seq'::regclass);
...
--
-- Name: room_reminders room_reminders_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.room_reminders
    ADD CONSTRAINT room_reminders_pkey PRIMARY KEY (reminder_id);
...
--
-- Name: idx_room_reminders_cooldown; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_room_reminders_cooldown ON public.room_reminders USING btree (room_id, sender_id, created_at DESC);


--
-- Name: idx_room_reminders_unread; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_room_reminders_unread ON public.room_reminders USING btree (receiver_id, is_read, created_at DESC);
...
--
-- Name: faq_questions faq_questions_answered_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.faq_questions
    ADD CONSTRAINT faq_questions_answered_by_fkey FOREIGN KEY (answered_by) REFERENCES public.admin_login(admin_id);


--
-- Name: faq_questions faq_questions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.faq_questions
    ADD CONSTRAINT faq_questions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.user_login(user_id) ON DELETE CASCADE;
...
--
-- Name: room_reminders fk_room_reminders_receiver; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.room_reminders
    ADD CONSTRAINT fk_room_reminders_receiver FOREIGN KEY (receiver_id) REFERENCES public.user_login(user_id) ON DELETE CASCADE;


--
-- Name: room_reminders fk_room_reminders_room; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.room_reminders
    ADD CONSTRAINT fk_room_reminders_room FOREIGN KEY (room_id) REFERENCES public.room(room_id) ON DELETE CASCADE;


--
-- Name: room_reminders fk_room_reminders_sender; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.room_reminders
    ADD CONSTRAINT fk_room_reminders_sender FOREIGN KEY (sender_id) REFERENCES public.user_login(user_id) ON DELETE CASCADE;
...
\unrestrict cG64PaP8J2OgXFS6aF3nxpNfpJCDj2buLGdBuODncfQhoy4c5Sk5GBMqHUnRRcF
