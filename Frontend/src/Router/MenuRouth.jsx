...
import AdminTransactions from "../Admin/Transactions/AdminTransactions.jsx";
import PrivacyPolicy from "../pages/Legal/PrivacyPolicy";
import TermsOfService from "../pages/Legal/TermsOfService";
import Status from "../pages/Legal/Status";
import WalletWidget from "../Wallet/WalletWidget";
import AdminDisputes from "../Admin/Dashboard/Components/Disputes/AdminDisputes.jsx";
...
const Layout = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("show-top-notification", handleNotification);
    };
  }, []);
  ...
  const hideWallet = hideLayout || location.pathname.startsWith("/deal/");
