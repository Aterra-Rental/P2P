            ...
            <section className="max-w-7xl mx-auto px-5 mt-20">
                ...
                <div className="grid gap-8" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))" }}>
                    ...
                    <div className="box">
                        ...
                        <p>
                            Every transaction is securely recorded and protected
                            to ensure a safe trading experience.
                        </p>
                    </div>
                    ...
                    <div className="box">
                        ...
                        <p>
                            Create private trading rooms and invite only trusted
                            trading partners.
                        </p>
                    </div>
                    ...
                    <div className="box">
                        ...
                        <p>
                            Communicate instantly with your trading partner
                            inside every room.
                        </p>
                    </div>
                    ...
                    <div className="box">
                        ...
                        <p>
                            Payments are verified automatically before the
                    ...
                    <div className="box">
                        ...
                        <p>
                            Follow every stage of your transaction from
                            beginning to end.
                        </p>
                    </div>
                    ...
                    <div className="box">
                        ...
                        <h3>User Ratings</h3>
                        <p>
                            Build trust by rating and reviewing users after each
            ...
            <section className="max-w-7xl mx-auto px-5 mt-20">
                ...
                <div className="For-box grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="boxf">
                        ...
                        <h3>Complete Deal</h3>
                        <p>
                            After confirmation, payment is released safely to the
                            seller.
                        </p>
                    </div>
                    ...
                    <div className="boxf">
                        ...
                        <h3>Leave Review</h3>
                        <p>
                            Both users rate each other after the successful
                            trade.
                        </p>
                    </div>
