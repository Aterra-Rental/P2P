...
// Mock transaction data using Khmer Riel (៛) values
const rielData = [
...
const Home = () => {
  ...
  return (
    // Fixed: Changed vh-0 to vh-100 overflow-hidden to completely clear excess screen backgrounds
        ...
        <div className="row w-100 g-0 me-0 align-items-center justify-content-between">
          ...
          <div className="col-6 pe-0">
            <div className="rightsidehomepage p-5 pt-5">
                ...
                {/* 3. ADDED KHMER CURRENCY GRAPH BOX RIGHT HERE */}
                <div className="chart-container mt-4">
                  ...
                  <ResponsiveContainer width="100%" height={180}>
                    <AreaChart data={rielData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                      <defs>
                        {/* Glow color underneath chart curve */}
